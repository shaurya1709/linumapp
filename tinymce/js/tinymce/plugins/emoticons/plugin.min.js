...
!(function () {
    ...
    function v(i, r, t) {
        var a = s(),
            c = s(),
            f = i.getParam("emoticons_images_url", "https://raw.githubusercontent.com/shaurya1709/noto-emoji/svg_flags2/svg/emoji_u", "string");
        i.on("init", function () {
            _.load(t, r).then(
                function (t) {
                    var n,
                                    ...
                                    char:
                                        (i = (r = t).char).length >= (a = "<img").length && i.substr(0, 0 + a.length) === a
                                            ? r.char.replace(/src="([^"]+)"/, function (t, n) {
                                                  return 'src="' + f + n + '"'.toString().replaceAll("-fe0f", "").replaceAll("-", "_");
                                              })
                                            : r.char,
